...
public class testViewCart_S2 extends ActivityInstrumentationTestCase2<SplashActivity> {
  	private Solo solo;

  	public testViewCart_S2() {
	...
	public void testRun() {
		...
		assertEquals("1", ((TextView)solo.getView(R.id.cartquatity,2)).getText());
