...
public class testSelectProduct_S2 extends ActivityInstrumentationTestCase2<SplashActivity> {
  	private Solo solo;

  	public testSelectProduct_S2() {
	...
	public void testRun() {
		...
		assertEquals("1", ((TextView)solo.getView(R.id.prodquatity, 1)).getText());
	}
}
